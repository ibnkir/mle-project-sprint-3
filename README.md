...
- Числовые параметры модели должны принимать неотрицательные значения,
...
- `services/Dockerfile_ml_service` - конфигурационный файл для сборки и запуска контейнера с основным сервисом;
- `services/docker-compose.yaml` - конфигурационный файл для сборки и запуска контейнеров для всех сервисов в режиме Docker Compose;
